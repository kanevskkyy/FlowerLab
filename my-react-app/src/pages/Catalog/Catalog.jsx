...
const imageMap = {
  bouquet1S, bouquet1M, bouquet1L, bouquet1XL,
  bouquet2S, bouquet2M, bouquet2L, bouquet2XL,
  bouquet3S, bouquet3M, bouquet3L, bouquet3XL,
  bouquet4S, bouquet4M, bouquet4L, bouquet4XL,
  bouquet5S, bouquet5M, bouquet5L, bouquet5XL,
  bouquet6S, bouquet6M, bouquet6L, bouquet6XL,
  bouquet7S, bouquet7M, bouquet7L, bouquet7XL,
  bouquet8S, bouquet8M, bouquet8L, bouquet8XL,
  bouquet9S, bouquet9M, bouquet9L, bouquet9XL,
  bouquet10S, bouquet10M, bouquet10L, bouquet10XL,
  bouquet11S, bouquet11M, bouquet11L, bouquet11XL,
  bouquet12S, bouquet12M, bouquet12L, bouquet12XL,
  bouquet13S, bouquet13M, bouquet13L, bouquet13XL,
  bouquet14S, bouquet14M, bouquet14L, bouquet14XL,
  bouquet15S, bouquet15M, bouquet15L, bouquet15XL
};
...
const Catalog = () => {
  ...
  const getFilteredProducts = () => {
    ...
    if (filters) {
      ...
      // Quantity
      if (filters.quantity) {
        filtered = filtered.filter(p => p.quantity >= parseInt(filters.quantity));
      }
          ...
          >
            ...
            {sortOpen && (
              <div className="sort-popup" ref={sortRef}>
                <p onClick={() => handleSortChange("date-new")}>Date: New to old</p>
                <p onClick={() => handleSortChange("date-old")}>Date: Old to new</p>
                <p onClick={() => handleSortChange("price-high")}>Price: High to low</p>
                <p onClick={() => handleSortChange("price-low")}>Price: Low to high</p>
          ...
          <div className="pagination">
            ...
            <div className="page-numbers">
              ...
              {getPageNumbers().map((page, index) => (
                <span
                  key={index}
                  className={page === currentPage ? 'active' : page === '...' ? 'dots' : ''}
