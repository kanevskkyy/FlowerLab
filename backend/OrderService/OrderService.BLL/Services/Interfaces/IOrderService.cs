...
namespace OrderService.BLL.Services.Interfaces
{
    public interface IOrderService
    {
        ...
        Task<OrderCreateResultDto> CreateAsync(Guid? userId, string? userFirstName, string? userLastName, string? userPhoneNumber, OrderCreateDto dto, decimal personalDiscount, CancellationToken cancellationToken = default);
